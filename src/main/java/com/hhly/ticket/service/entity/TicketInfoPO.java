...
public class TicketInfoPO {
    ...
    public TicketInfoPO(TicketBO ticketBO) {
		this.lotteryCode = ticketBO.getLotteryCode();
		this.lotteryIssue = ticketBO.getLotteryIssue();
		this.lotteryChildCode = ticketBO.getLotteryChildCode();
		this.userId = ticketBO.getUserId();
		this.ticketMoney = ticketBO.getTicketMoney();
		this.orderCode = ticketBO.getOrderCode();
		this.endTicketTime = ticketBO.getEndTicketTime();
		this.contentType = (short) ticketBO.getContentType();
		this.buyScreen = ticketBO.getBuyScreen();
		this.multipleNum = ticketBO.getMultipleNum();
		this.ticketStatus = ticketBO.getTicketStatus().shortValue();
		this.ticketContent = ticketBO.getTicketContent();
		this.lottoAdd = (short) ticketBO.getLottoAdd();
		this.ticketChange = ticketBO.getTicketChange();
		this.startMatchTime = ticketBO.getStartMatchTime();
		this.saleTime = ticketBO.getSaleTime();
		this.activitySource = ticketBO.getActivitySource();
		this.orderDetailId = ticketBO.getOrderDetailId();
		this.winningStatus = ticketBO.getWinningStatus().shortValue();
		this.changeId = ticketBO.getChangeId();
	}
    ...
    public Short getWinningDetail() {
        return winningDetail;
    }

    public void setWinningDetail(Short winningDetail) {
