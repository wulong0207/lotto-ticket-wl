package com.hhly.ticket.service.ticket.dealer.zhongying.convert;
 ...
 * @version 1.0
 */
public class SportZYConvert extends AbstractConvert {
	...
	protected String getLotteryCode(TicketBO bo) {
		...
		throw new ServiceRuntimeException("不存在彩种");
	}
	...
	public String getPlayType(TicketBO bo) {
		return bo.getChannelLotteryCode() + "1" + bo.getChannelPlayType();
	}
