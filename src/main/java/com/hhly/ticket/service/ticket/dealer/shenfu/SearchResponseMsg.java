...
import com.hhly.ticket.service.ticket.dealer.shenfu.response.SearchResponseOrder;
import com.hhly.ticket.service.ticket.dealer.shenfu.response.SearchTicket;
...
public class SearchResponseMsg extends AbstractXml implements ICheckResponse{
	...
	public boolean isSuccess() {
		return ShenFuDealer.SUCCESS.equals(code);
	}
